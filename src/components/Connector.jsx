        ...
        <div className="reveal">
          ...
          <div className="mt-8 space-y-4">
            <p className="text-base text-cream2 leading-[1.9]">
              <strong className="text-off-white">Marcos Galian no es solo productor de eventos.</strong> Es el punto donde convergen el sector público, los medios, el sector privado y las instituciones de Neuquén y la Patagonia.
            </p>
            <p className="text-base text-cream2 leading-[1.9]">
